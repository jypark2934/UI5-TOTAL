		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "연습장",
									"targetURL": "#sapsyncpractice1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapsyncpractice1-display": {
								"semanticObject": "sapsyncpractice1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.sync.practice1",
									"url": sap.ui.require.toUrl("sap/sync/practice1")
								}
							}
						}
					}
